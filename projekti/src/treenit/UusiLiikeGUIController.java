 ...
 *
 */
public class UusiLiikeGUIController <TYPE extends Tietue> implements ModalControllerInterface<TYPE>,Initializable  { //implements ModalControllerInterface<String> {
